...
I use dashboard package in Emacs. This section contains the configuration for that
...
it. You can remove the line which calls the =my/gui-hide-bars= function if you don't
want this.
...
=my/org-logbook-display-states-on-calendar=. It can be used to visualize both
...
In the same manner, you can call the =my/org-logbook-display-notes-on-calendar= and you will see
...
There is a function called =my/org-roam-insert-nodes-by-tags=, which enables you to
